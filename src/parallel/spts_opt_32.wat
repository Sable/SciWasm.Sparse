(module
  ...
  (func $spts_csr_level_sync_free_nobusywait (export "spts_csr_level_sync_free_nobusywait") (param $csr_rowptr i32) (param $csr_col i32) (param $csr_val i32) (param $x i32) (param $y i32) (param $len i32) (param $current i32)
    (local $i i32)
    (local $j i32)
    (local $end i32)
    (local $temp f32)
  ...
  (func $spts_csr_level_sync_free_busywait (export "spts_csr_level_sync_free_busywait") (param $id i32) (param $csr_rowptr i32) (param $csr_col i32) (param $csr_val i32) (param $x i32) (param $y i32) (param $len i32) (param $current i32) (param $flag i32) (param $local_level i32) (param $global_level i32)
    ...
    (i32.add)
    (local.set $csr_val)
    (i32.load (local.get $global_level))
    ...
    if
      ...
      (local.get $len)
      (local.get $current)
      (call $spts_csr_level_sync_free_nobusywait)
      (return)
    end
    (loop $outer_loop
      ;; check if there are non-diagonals elements in the row.
  ...
  (func $spts_csr_opt_level_sync_free_wrapper (export "spts_csr_opt_level_sync_free_wrapper") (param $id i32) (param $level_ptr i32) (param $csr_rowptr i32) (param $csr_col i32) (param $csr_val i32) (param $x i32) (param $y i32) (param $permutation i32) (param $nlevels i32) (param $barrier i32) (param $global_flag i32) (param $flag i32) (param $global_level i32) (param $level_barrier i32) (param $nthreads i32) (param $N i32) (param $inner_max i32)
    (local $i i32)
    (local $j i32)
    (local $nrows i32)
    (local $len i32)
