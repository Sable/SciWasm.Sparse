...
def result(json_string):
  ...
  if tests == 'coo':
    f.write(str(parsed_json['coo_nnz_sd']))
    f.write(",")
    f.write(str(parsed_json['coo_nnz']))
    f.write(",")
    f.write(str(parsed_json['coo_nnz_sum']))
    f.write(",")
    f.write(str(parsed_json['coo_gs_sd']))
    f.write(",")
    f.write(str(parsed_json['coo_gs']))
    f.write(",")
    f.write(str(parsed_json['coo_gs_sum']))
  ...
  if tests == 'csr_nnz':
    ...
    f.write(",")
    f.write(str(parsed_json['csr_nnz_sorted_sd']))
    f.write(",")
    f.write(str(parsed_json['csr_nnz_sorted']))
    f.write(",")
    f.write(str(parsed_json['csr_nnz_sorted_sum']))
    f.write(",")
    f.write(str(parsed_json['csr_nnz_gs_sorted_sd']))
    f.write(",")
    f.write(str(parsed_json['csr_nnz_gs_sorted']))
    f.write(",")
    f.write(str(parsed_json['csr_nnz_gs_sorted_sum']))
    f.write(",")
